...
static void ide_atapi_run_command(struct ide_controller* ctrl)
{
    ...
    case 0x12: // Inquiry
        ...
        ide_pio_store_string(ctrl, "", 8, 8, 0, 1);
        ide_pio_store_string(ctrl, "TermFix", 16, 16, 0, 1);
        ide_pio_store_string(ctrl, "", 24, 4, 0, 1);
...
static void ide_identify(struct ide_controller* ctrl)
{
    ...
    if (cdrom) {
        ...
        // Serial number
        ide_pio_store_string(ctrl, "PIXELCD", 10 << 1, 20, 1, 1);
        ide_pio_store_string(ctrl, "0.0.1", 23 << 1, 8, 1, 1);
        ide_pio_store_string(ctrl, "Pixelsuft TermFix CD-ROM Drive", 27 << 1, 40, 1, 1);
...
#define NOT_TRANSLATED(obj, field) obj->field[obj->selected << 1]
        ...
        ide_pio_store_string(ctrl, "PIXELSUFTHD", 10 << 1, 20, 1, 0);
        ...
        ide_pio_store_string(ctrl, "Pixelsuft TermFix Hard Disk Drive", 27 << 1, 40, 1, 1);
